...
window.speak = async () => {
    ...
    // Don't echo user input but query FastAPI server to get response by LLM (with AI Serach augmentation)
    // ===================================================================================================
    let inputText = document.getElementById('spokenText').value
    
    let url = "http://localhost:80/query"
    ...
    const spokenText = result["result"]
    // ===================================================================================================
